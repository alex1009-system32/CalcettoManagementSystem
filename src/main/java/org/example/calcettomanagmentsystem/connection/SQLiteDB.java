...
public class SQLiteDB {
    ...
    private static final String testSetup = """
              ...
              VALUES (1, 'Winter Open 2024', '2024-01-15', 7, 2, 0, 2),
                     (2, 'Spring Invitational', '2024-03-10', 5, 2, 0, 2),
                     (3, 'Summer Championship', '2024-06-20', 14, 2, 0, 2),
                     (4, 'Fall Classic', '2024-09-05', 10, 2, 0, 2),
                     (5, 'Weekend Warrior Cup', '2025-07-04', 2, 1, 0, 2);
            
              INSERT INTO team (tid, team_name)
              VALUES (1, 'Cyber Knights'),
                     (2, 'Data Wizards'),
                     (3, 'SQL Stars'),
                     (4, 'Byte Brawlers'),
                     (5, 'Null Pointers'),
              ...
              VALUES (1, 'Alice Smith', 'alice@example.com', 1, 1),
